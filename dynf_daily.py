...
dsets = xr.open_mfdataset("/scratch/02441/bcash/ufs.s2s.c384_t025/run."+expver+"/postp/dynf0??_regrid*nc")
print(dsets)
...
# Write out file
avg.to_netcdf("/scratch/02441/bcash/ufs.s2s.c384_t025/run."+expver+"/postp/dynf_daily_"+expver+"_0p25x0p25.nc")
