#!/bin/sh
#SBATCH -J m6r_regr           # Job name
#SBATCH -o m6r_regr.o%j       # Name of stdout output file
#SBATCH -e m6r_regr.e%j       # Name of stderr error file
...
export UFSOUTPUT_PROC="mom6.r"
export PROJECT="TG-ATM140004"
# Launch MPI code... 

ibrun -n 1 python ./mom6.r_regrid.py         # Use ibrun instead of mpirun or mpiexec
