#!/bin/tcsh -fe
#
# $Id: list_ncvars.csh,v 1.1.2.3 2010/06/03 00:15:59 afy Exp $
# ------------------------------------------------------------------------------
...
#module load fre-commands
#source /usr/local/Modules/default/init/csh
#module unload netcdf
#module load fre netcdf/4.2 mpich2
...
#alias list_ncvars /home1/02441/bcash/ufscomp_utils/list_ncvars.exe
...
#which list_ncvars.exe
set out=`list_ncvars < $nml_name`
#echo $out | sed 's/ /,/g' || exit 1
echo $out | sed 's/TMP500_300 //g' | sed 's/ /,/g' || exit 1
#echo "TEMPORARY BUG WORK-AROUND SKIPPING TMP500_300"
