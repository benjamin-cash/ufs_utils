...
from ufsvarutils import parse_mom6static, parse_mom6rgrid, create_regridder, copyattrs
...
# Create list of different variable types
        xhyhlist = [vname for vname in vlist if "lonh" in glist[vname] and "lath" in glist[vname]]
        xqyhlist = [vname for vname in vlist if "lonq" in glist[vname] and "lath" in glist[vname]]
        xhyqlist = [vname for vname in vlist if "lonh" in glist[vname] and "latq" in glist[vname]]
        xqyqlist = [vname for vname in vlist if "lonq" in glist[vname] and "latq" in glist[vname]]
